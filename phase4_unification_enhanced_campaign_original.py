#!/usr/bin/env python3
"""
Phase 4 Unification Enhanced Campaign - ORIGINAL VERSION
=======================================================

This is the exact script from the Proof Sketch file, using the correct
tetrahedral kernel λ = √6/2 ≈ 1.2247 as specified in the sim stack document.
"""
...
def main():
    """Original simulation from Proof Sketch file."""
    ...
    print("Phase 4 Unification Enhanced Campaign - ORIGINAL VERSION")
    print("=" * 60)
    ...
    plot_path = "outputs/phase4_original_lambda_harmonic_ladder.png"
    ...
    csv_path = "outputs/phase4_original_eigen_summary.csv"
    ...
    # Check if eigenvalues follow λ² scaling
